...
let CategoryRepository = class CategoryRepository {
    constructor(model = category_1.default) {
        this.model = model;
    }
    create(data) {
    ...
    findBySlug(slug) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.model.findOne({ slug });
            return result;
        });
    }
    findByParentCategory(parentCategory) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.model.find({ parentCategory });
            return result;
        });
    }
