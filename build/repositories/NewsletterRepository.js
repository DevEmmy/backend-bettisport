...
const news_letter_1 = __importDefault(require("../models/news-letter"));
let NewsletterRepository = class NewsletterRepository {
    constructor() {
        this.model = news_letter_1.default;
    }
    create(email) {
    ...
    deleteByEmail(email) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.model.findOneAndDelete({ email }).exec();
        });
    }
};
...
exports.default = NewsletterRepository;
